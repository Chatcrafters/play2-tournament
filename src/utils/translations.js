export const translations = {
  de: {
    ...
    results: {
      ...
      diff: 'Diff',
      hide: 'Ausblenden',
      resultEntered: 'Ergebnis eingegeben'
    },
    ...
    // Event Form
    // DEUTSCHER form-Bereich - KOMPLETT ERSETZEN:
...
form: {
  ...
  genderMode: 'Geschlechterkategorie',
  mixed: 'Mixed',
  ...
  es: {
    ...
    app: {
      ...
      backToEventOverview: 'Volver al resumen del evento'
    },
    ...
    results: {
      ...
      diff: 'Diff',
      hide: 'Ocultar',
      resultEntered: 'Resultado ingresado'
    },
    ...
    // Event Form
    // SPANISCHER form-Bereich - KOMPLETT ERSETZEN:
...
form: {
  ...
  lunchBreak: 'Descanso para almorzar',
  coffeBreak: 'Descanso para café',
  ...
  genderMode: 'Categoría de género',
  mixed: 'Mixto',
  // FEHLENDE KEYS HINZUGEFÜGT:
  playMode: 'Modo de juego',
  registrationOpen: 'Registro abierto'
    ...
    player: {
      ...
      waitingPlayers: 'Lista de espera',
